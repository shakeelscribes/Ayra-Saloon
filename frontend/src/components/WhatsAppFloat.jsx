...
/**
 * Floating WhatsApp chat button. Fades in after a little scrolling so the
 * first paint stays clean; hidden entirely under prefers-reduced-motion is
 * unnecessary here because its entrance is a simple opacity/scale fade.
 */
