...
export function ComparisonSlider({
  ...
  const positionFromPointer = useCallback((event) => {
    ...
    <div
      ...
      <div
        ...
        <span
          aria-hidden="true"
          className={cn(
            "absolute bg-gold-400",
            isHorizontal ? "inset-y-0 w-0.5" : "inset-x-0 h-0.5"
          )} />
        <span
          className="relative flex size-8 items-center justify-center rounded-full border border-gold-500/60 bg-emerald-950/85 text-gold-300 shadow-lg backdrop-blur-sm">
